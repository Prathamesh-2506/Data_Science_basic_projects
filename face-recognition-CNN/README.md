...
Detects faces in images using two approaches: OpenCV Haar Cascades and Multi-task Cascaded Convolutional Networks. Draws bounding boxes around detected faces and compares the results of both methods.
